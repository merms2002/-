...
if (!b[0]) return conn.reply(m.chat, `*غلط كده يحب الصح*\n*موضوع اختيار|اختيار1|اختيار2*`, fkontak, m) 
...
let texto = `📊 هذا الاستطلاع من\n*❤️⇢ ${conn.getName(m.sender)}*\n*${text.split('|')[0]}*`

return conn.sendPoll(m.chat, texto, a, {mentions: m})}
handler.command = ['poll', 'اختيار', 'crearencuesta', 'startpoll', 'encuestas', 'polls'] 
