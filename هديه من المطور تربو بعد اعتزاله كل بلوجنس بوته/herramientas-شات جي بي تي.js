...
if (command == 'بوت' || command == 'chatgpt') {
try {     
...
let syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por تربو, tu seras ✪┋𝐓𝐀𝐑𝐁𝐎𝐎☞𝐁𝐎𝐓┋✪`;  
...
handler.command = /^(openai|chatgpt|بوت|ai|openai2|chatgpt2|ia2)$/i;
